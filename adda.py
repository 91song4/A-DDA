...
class Adda:
    ...
    def log(self,user_id, api_uri, method,):
        ...
        if flag == 0:
            cursor.execute('create table log (id int(11) primary key auto_increment, created datetime default current_timestamp, user_id varchar(20), api_uri varchar(20) not null, method varchar(20) not null, foreign key (user_id) references user(id) on delete cascade on update cascade);')
